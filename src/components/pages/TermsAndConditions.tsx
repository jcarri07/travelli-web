const TermsAndConditions = () => {
  return (
    <div className="bg-white text-color3 p-8 rounded-xl max-w-4xl mx-auto mt-24">
      ...
      <section className="mb-4">
        <h2 className="text-xl font-semibold mb-2">5. Responsabilidad de Travelli</h2>
        <p>
      ...
      <section className="mb-4">
        <h2 className="text-xl font-semibold mb-2">6. Cancelaciones y Reservaciones</h2>
        <p>
      ...
      <section className="mb-4">
        <h2 className="text-xl font-semibold mb-2">7. Verificación de Identidad y Edad</h2>
        <p>
      ...
      <section className="mb-4">
        <h2 className="text-xl font-semibold mb-2">8. Eliminación de Cuenta</h2>
        <p>
      ...
      <section className="mb-4">
        <h2 className="text-xl font-semibold mb-2">10. Modificaciones de los Términos</h2>
        <p>
